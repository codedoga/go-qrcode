...
import (
	qrv2 "github.com/codedoga/go-qrcode//v2"
	"github.com/codedoga/go-qrcode//writer/standard"

	qrv1 "github.com/codedoga/go-qrcode/"
)

func main() {
	// draw a QRCode image with
	// - "https://github.com/codedoga/go-qrcode/" source text
	// - circle shape
...
func v1() {
	...
	qrc, err := qrv1.NewWithConfig("https://github.com/codedoga/go-qrcode/", encodeConfig,
...
func v2() {
	qrc, err := qrv2.NewWith("https://github.com/codedoga/go-qrcode/",
